...
- **Dhruv (rival antagonist)** — a fictional flying rival who appears every
  5 towers (pipes) you pass, gives a brief "DHRUV INCOMING!" warning, and
  homes in slightly on your height. Dodge him for a +10 bonus, or get caught
  without a shield for a distinct "ELIMINATED!" ending with its own sting
  instead of the usual caught sound
